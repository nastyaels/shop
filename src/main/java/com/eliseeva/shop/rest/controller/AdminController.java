...
//    @PostMapping(path = "editCake", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
//    public ResponseEntity<InfoAboutCake> editCake(@RequestBody InfoAboutCake cake) {
...
//    @GetMapping(value = "deleteCake/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
